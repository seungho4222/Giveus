...
const FundingRegister = () => {
  ...
  const handleTargetChange = (value: string) => {
    setRegistrationData(prevData => ({ ...prevData, targetAmount: parseInt(value) }))
  }
  ...
  const handleRegistrationChange = (value: string) => {
    setRegistrationData(prevData => ({...prevData, registrationNumber: value}))
  }
  ...
  const handleGenderChange = (value: string) => {
    if (value === '1' || '3') {
      setRegistrationData(prevData => ({ ...prevData, gender: 'M'}))
    } else {
      setRegistrationData(prevData => ({ ...prevData, gender: 'F'}))
    }
    ...
    <>
      ...
      <StyledFundingRegisterPage>
        ...
        <Button
          ...
          $borderRadius={'10px'}
          $children={'입력 완료'}
          onButtonClick={() => (console.log(registrationData))}
        />
      </StyledFundingRegisterPage>
    </>
  )
